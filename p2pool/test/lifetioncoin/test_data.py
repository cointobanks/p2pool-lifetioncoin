...
from p2pool.lifetioncoin import data, networks
...
class Test(unittest.TestCase):
    ...
    def test_header_hash_lifetioncoin(self):
        assert networks.nets['lifetioncoin'].POW_FUNC(data.block_header_type.pack(dict(
            version=3,
    ...
    def test_address_to_pubkey_hash(self):
        assert data.address_to_pubkey_hash('7gnwGHt17heGpG9Crfeh4KGpYNFugPhJdh', networks.nets['lifetioncoin']) == pack.IntType(160).unpack('9dc8b19033a16913b6e45437f76d0ab649e9e516'.decode('hex'))
