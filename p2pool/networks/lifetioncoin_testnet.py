...
PARENT = networks.nets['lifetioncoin_testnet']
...
PERSIST = False
WORKER_PORT = 17903
BOOTSTRAP_ADDRS = 'p2pool.lifetioncoinninja.pl test.p2pool.masternode.io test.p2pool.lifetioncoin.siampm.com'.split(' ')
ANNOUNCE_CHANNEL = ''
